...
public class WidevineMediaCallback implements MediaDrmCallback {
    ...
    private String sessionId, userId, merchant;

    //region Get And Set
    public void setDefaultLicenseUrl(String defaultLicenseUrl) {
    ...
    public WidevineMediaCallback(HttpDataSource.Factory dataSourceFactory) {
        this("https://lic.staging.drmtoday.com/license-proxy-widevine/cenc/?specConform=true", false, dataSourceFactory);
    }
     ...
     */
    public WidevineMediaCallback(String defaultLicenseUrl, HttpDataSource.Factory dataSourceFactory) {
     ...
     * @param dataSourceFactory A factory from which to obtain {@link HttpDataSource} instances.
     */
    public WidevineMediaCallback(String defaultLicenseUrl, boolean forceDefaultLicenseUrl,
...
//        }
        ...
        synchronized (keyRequestProperties) {
            ...
            requestProperties.put("dt-custom-data",
                    Base64.encodeToString(getCustomJsonData().getBytes(), Base64.NO_WRAP));
        }

        return executePost(dataSourceFactory, url, request.getData(), requestProperties);

//        JSONObject jsonObject = new JSONObject(new String(results));
//        String license = jsonObject.getString("license");
//        Log.d("EventLogger", "License Json: " + jsonObject.toString());
//        return Base64.decode(license, Base64.DEFAULT);
    ...
    private String getCustomJsonData() {
