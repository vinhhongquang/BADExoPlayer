...
public class DefaultDrmSessionManager<T extends ExoMediaCrypto> implements DrmSessionManager<T> {
  ...
  public static final class Builder {
    ...
    @Nullable private OnSaveKeyResponseInMediaDrm onSaveKeyResponseInMediaDrm;
     ...
     * xxBADxx
     */
    public Builder setOnSaveKeyResponseInMediaDrm(@Nullable OnSaveKeyResponseInMediaDrm onSaveKeyResponseInMediaDrm){
      this.onSaveKeyResponseInMediaDrm = onSaveKeyResponseInMediaDrm;
      return this;
    }
  ...
  private DefaultDrmSessionManager(
      ...
      @Nullable OnSaveKeyResponseInMediaDrm onSaveKeyResponseInMediaDrm) {
  ...
  //region xxxBADxxx
  public interface OnSaveKeyResponseInMediaDrm {
    void onSaveKeyResponse(byte[] keyResponse);
  }
  //endregion
}
